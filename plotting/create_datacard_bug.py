...
#    f.write("shapes psi2s_tau      signal   param_ws.root wspace:psi2s_tau_SR \n")
    f.write("shapes onia      signal   param_ws.root wspace:mc_comb_SR \n")
    ...
    f.write("process \t jpsi_mu \t jpsi_tau \t chic0_mu \t chic1_mu \t chic2_mu \t hc_mu \t jpsi_hc \t psi2s_mu  \t \t onia \t fakes\n") 
    ...
    f.write("bc              lnN 1.3 1.3  1.3 1.3  1.3 1.3 1.3 1.3 - -\n")
...
def create_datacard_onlypass(histos,name,label):
    ...
    f.write("kmax * number of independent systematical uncertainties \n") 
    f.write("--------------------------------------------------------------------------- \n") 
    f.write("shapes * * datacard_pass_Q_sq.root $PROCESS $PROCESS_$SYSTEMATIC \n")
    f.write("--------------------------------------------------------------------------- \n") 
    f.write("bin signal\n") 
    f.write("observation %.2f\n"%histos['data'].Integral())
