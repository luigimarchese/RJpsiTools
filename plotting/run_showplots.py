...
asimov = True
#categories_1 = ['ip3d_sig_dcorr<-2','ip3d_sig>=-2 & ip3d_sig<0','ip3d_sig>=0 & ip3d_sig<2','ip3d_sig>=2']
...
for cat1 in categories_1:
        for cat2 in categories_2:
                ...
                command ='python showplots_v15.py --asimov  --preselection_plus "'+preselection_plus+'" --label '+str(label)+' > plots_ul/logs/log_'+str(label)+'.log &' 
