...
def plot_shape_nuisances(histos_folder, variable, channel, sample_names=sample_names, which_sample_single_bbb =[], plot3d = False, fakes = True, path = '/work/friti/rjpsi_tools/CMSSW_10_6_14/src/RJpsiTools/plotting/plots_ul/', compute_sf = False, verbose = False):
    ...
    mc_corr_syst = ['bccorr']
    fakes_shape_syst = ['fakesshape','fakesmethod']
    ...
    for sname in sample_names+['fakes']:
        ...
        if (sname != 'data' and sname!='dimuon' ):
            ...
            for syst in total_syst:
                ...
                if syst in bbb_syst:
                    ...
                    if len(which_sample_single_bbb)>=1:
                        ...
                        if not 'jpsi_x_mu_from_'+which_sample_single_bbb[int(syst.replace('bbb','').replace(channel,''))-1] == sname:
                            ...
                            syst = 'single_'+syst
                    syst = sname +'_'+syst
                    #if variable == 'Q_sq' and channel == 'ch2' and syst == 'jpsi_x_mu_from_xi_single_bbb5ch2':
                    #    print("Hello syst ",syst)
                    #    print(histo_central.GetBinContent(1))
                if syst in mc_corr_syst:
                    if sname == 'data' or 'jpsi_x_mu' in sname:
                        continue
                print(sname, syst, channel)
                ...
                #if syst=='fakesmethod':
                #    print("fakesmethod", histo_central.GetBinContent(1),histo_up.GetBinContent(1),histo_down.GetBinContent(1))
...
if __name__ == "__main__":
    ...
    histos_folder = '15Sep2022_10h37m07s'
    variable = 'Q_sq'
    plot_shape_nuisances(histos_folder, variable,'ch1',sample_names_explicit_jpsimother_compressed )
