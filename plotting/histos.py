...
# histos['Bmass'                     ] = (ROOT.RDF.TH1DModel('Bmass'                     , '', 80,      3,     8), '3#mu mass (GeV)'                                               , 0)
...
histos['bvtx_lxy_unc'              ] = (ROOT.RDF.TH1DModel('bvtx_lxy_unc'              , '', 60,      0,  0.02), '#sigma_{L_{xy}} (cm)'                                          , 1)
histos['bvtx_lxy_sig_corr'         ] = (ROOT.RDF.TH1DModel('bvtx_lxy_sig_corr'         , '', 50,      0,    60), 'corrected L_{xy}/#sigma_{L_{xy}}'                              , 1)
histos['bvtx_lxy_unc_corr'         ] = (ROOT.RDF.TH1DModel('bvtx_lxy_unc_corr'         , '', 60,      0,  0.02), 'corrected #sigma_{L_{xy}} (cm)'                                , 1)
...
histos['jpsivtx_lxy_unc'           ] = (ROOT.RDF.TH1DModel('jpsivtx_lxy_unc'           , '', 60,      0,  0.02), '#sigma_{L_{xy}} (cm)'                                          , 1)
histos['jpsivtx_lxy_unc_corr'      ] = (ROOT.RDF.TH1DModel('jpsivtx_lxy_unc_corr'      , '', 60,      0,  0.02), 'corrected #sigma_{L_{xy}} (cm)'                                          , 1)
histos['jpsivtx_lxy_sig_corr'      ] = (ROOT.RDF.TH1DModel('jpsivtx_lxy_sig_corr'      , '', 50,      0,    60), 'corrected L_{xy}/#sigma_{L_{xy}}'                                        , 1)
...
histos['Q_sq'                      ] = (ROOT.RDF.TH1DModel('Q_sq'                      , '', 24,      3,    10.5), 'q^{2} (GeV^{2})'                                               , 0)
...
histos['k_raw_db_corr_iso04'       ] = (ROOT.RDF.TH1DModel('k_raw_db_corr_iso04'       , '', 50,      0,    20), '#mu_{3} #Delta#beta-corr. I^{abs}_{R=0.4}'                     , 0)
...
histos['k_raw_db_corr_iso03_rel'   ] = (ROOT.RDF.TH1DModel('k_raw_db_corr_iso03_rel'   , '', 50,      0,     2), '#mu_{3} #Delta#beta-corr. I^{rel}_{R=0.3}'                     , 0)
...
histos['decay_time_ps'             ] = (ROOT.RDF.TH1DModel('decay_time_ps'             , '', 50,      0,    10), 't (ps)'                                                        , 0)
...
histos['ip3d_sig'                  ] = (ROOT.RDF.TH1DModel('ip3d_sig'                  , '', 50,     -5,     5), '#mu_{3} IP3D(vtx_{J/#Psi}) significance'                       , 0)
