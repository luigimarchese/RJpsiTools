...
histos['Bmass'                ] = (ROOT.RDF.TH1DModel('Bmass'                , '', 80,      3,     10), '3#mu mass (GeV)'                                               , 0)
...
histos['abs_k_dxy'            ] = (ROOT.RDF.TH1DModel('k_dxy'                , '', 50,      0,   0.2), '#mu_{3} |d_{xy}| (cm)'                                         , 1)
#histos['k_dxy_sig'            ] = (ROOT.RDF.TH1DModel('k_dxy_sig'            , '', 50,      0,     1), '#mu_{3} |d_{xy}|/#sigma_{d_{z}}'                               , 1)
...
histos['bvtx_lxy'             ] = (ROOT.RDF.TH1DModel('bvtx_lxy'             , '',100,      0,     2), 'L_{xy} (cm)'                                                   , 1)
histos['bvtx_lxy_unc'         ] = (ROOT.RDF.TH1DModel('bvtx_lxy_unc'         , '',100,      0,  0.02), '#sigma_{L_{xy}} (cm)'                                          , 1)
...
histos['jpsivtx_lxy'          ] = (ROOT.RDF.TH1DModel('jpsivtx_lxy'          , '',100,      0,     2), 'L_{xy} (cm)'                                                   , 1)
...
histos['Q_sq'                 ] = (ROOT.RDF.TH1DModel('Q_sq'                 , '', 24,      0,    10), 'q^{2} (GeV^{2})'                                               , 0)
...
histos['k_raw_db_corr_iso03_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_ch_pfiso03_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_n_pfiso03_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_pho_pfiso03_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_pu_pfiso03_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_db_corr_iso04_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_ch_pfiso04_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_n_pfiso04_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_pho_pfiso04_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_pu_pfiso04_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_trk_iso03_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_trk_iso05_rel'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_db_corr_iso03'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_ch_pfiso03'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_n_pfiso03'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_pho_pfiso03'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_pu_pfiso03'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_trk_iso03'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_trk_iso05'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_db_corr_iso04'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_ch_pfiso04'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_n_pfiso04'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
histos['k_raw_pho_pfiso04'              ] = (ROOT.RDF.TH1DModel('k_iso03'              , '', 50,      0,    20), '#mu_{3} I^{abs}_{R=0.3}'                                       , 0)
...
histos['mu1_iso03'             ] = (ROOT.RDF.TH1DModel('mu1_iso03'             , '', 50,      0,    20), '#mu_{1} I^{abs}_{R=0.3}'                                       , 0)
histos['mu1_iso04'             ] = (ROOT.RDF.TH1DModel('mu1_iso04'             , '', 50,      0,    20), '#mu_{1} I^{abs}_{R=0.3}'                                       , 0)
histos['mu2_iso03'             ] = (ROOT.RDF.TH1DModel('mu2_iso03'             , '', 50,      0,    20), '#mu_{2} I^{abs}_{R=0.3}'                                       , 0)
histos['mu2_iso04'             ] = (ROOT.RDF.TH1DModel('mu2_iso04'             , '', 50,      0,    20), '#mu_{2} I^{abs}_{R=0.3}'                                       , 0)
...
histos['mu1_iso03_rel'         ] = (ROOT.RDF.TH1DModel('mu1_iso03_rel'         , '', 50,      0,     2), '#mu_{1} I^{rel}_{R=0.3}'                                       , 0)
histos['mu1_iso04_rel'         ] = (ROOT.RDF.TH1DModel('mu1_iso04_rel'         , '', 50,      0,     2), '#mu_{1} I^{rel}_{R=0.3}'                                       , 0)
histos['mu2_iso03_rel'         ] = (ROOT.RDF.TH1DModel('mu2_iso03_rel'         , '', 50,      0,     2), '#mu_{2} I^{rel}_{R=0.3}'                                       , 0)
histos['mu2_iso04_rel'         ] = (ROOT.RDF.TH1DModel('mu2_iso04_rel'         , '', 50,      0,     2), '#mu_{2} I^{rel}_{R=0.3}'                                       , 0)
...
# histos['jpsiK_mass'           ] = (ROOT.RDF.TH1DModel('jpsiK_mass'           , '', 80,      2,     7), '(J/#Psi + K^{+}) mass (GeV)'                                   , 0)
...
histos['jpsipi_mass'          ] = (ROOT.RDF.TH1DModel('jpsipi_mass'          , '', 80,      2,     7), '(J/#Psi + #pi^{+}) mass (GeV)'                                 , 0)
...
histos['ip3d'                 ] = (ROOT.RDF.TH1DModel('ip3d'                 , '', 20,     -0.02,     0.02), 'ip3d'                                                          , 0)
histos['ip3d_sig'                 ] = (ROOT.RDF.TH1DModel('ip3d_sig'                 , '', 20,     -5,     5), 'ip3d_sig'                                                          , 0)
histos['ip3d_e'                 ] = (ROOT.RDF.TH1DModel('ip3d_e'                 , '', 20,     0,     0.01), 'ip3d_e'                                                          , 0)
histos['bct'                  ] = (ROOT.RDF.TH1DModel('bct'                  , '', 50,      0,  1e-1), 'ct (cm)'                                                       , 0)
#histos['npv_good'             ] = (ROOT.RDF.TH1DModel('npv_good'             , '', 70,      0,    70), '# good PV'                                                     , 0)
histos['mmm_p4_par'           ] = (ROOT.RDF.TH1DModel('mmm_p4_par'           , '', 50,    -50,   100), '3-#mu p_{#parallel} (GeV)'                                     , 0)
...
histos['decay_time'           ] = (ROOT.RDF.TH1DModel('decay_time'           , '', 50,      0,0.4e-9), 't (s)'                                                         , 0)
...
# histos['decay_time'           ] = (ROOT.RDF.TH1DModel('decay_time'           , '', 50,      0,  1e-9), 't (s)'    
