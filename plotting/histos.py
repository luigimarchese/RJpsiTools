...
histos_hm = dict()
histos_hm['jpsivtx_log10_lxy_sig_corr'     ] = (ROOT.RDF.TH1DModel('jpsivtx_log10_lxy_sig'     , '',20,     -1,     1), 'log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}/#sigma_{L_{xy}}'         , 1)
#histos_hm['Q_sq'                      ] = (ROOT.RDF.TH1DModel('Q_sq'                      , '', 15,      0,    10), 'q^{2} (GeV^{2})'                                               , 0)
...
histos = dict()   
histos_lowq2 = dict()   
histos_lessbins = dict()   

histos['Q_sq'                      ] = (ROOT.RDF.TH1DModel('Q_sq'                      , '', 20,      5.5,    10), 'q^{2} (GeV^{2})'                                               , 0)
#histos['Q_sq_corr'                      ] = (ROOT.RDF.TH1DModel('Q_sq'                      , '', 20,      5.5,    10), 'q^{2} (GeV^{2})'                                               , 0)
histos_lessbins['Q_sq'                      ] = (ROOT.RDF.TH1DModel('Q_sq'                      , '', 10,      5.5,    10), 'q^{2} (GeV^{2})'                                               , 0)
histos_lowq2['Q_sq'                      ] = (ROOT.RDF.TH1DModel('Q_sq'                      , '', 20,      0,    4.5), 'q^{2} (GeV^{2})'                                               , 0)
'''
#histos['fakerate_onlydata_13'                      ] = (ROOT.RDF.TH1DModel('fakerate_onlydata_3'                      , '', 60,      0,    1.), 'q^{2} (GeV^{2})'                                               , 0)
#histos['fakerate_onlymc_13'                      ] = (ROOT.RDF.TH1DModel('fakerate_onlymc_3'                      , '', 60,      0,    1.8), 'q^{2} (GeV^{2})'                                               , 0)
#histos['nn_alpha_13'                      ] = (ROOT.RDF.TH1DModel('nn_alpha_3'                      , '', 60,      0,    0.2), 'q^{2} (GeV^{2})'                                               , 0)
#histos['Q_sq'                      ] = (ROOT.RDF.TH1DModel('Q_sq'                      , '', 40,      0,    10), 'q^{2} (GeV^{2})'                                               , 0)
...
#histos['ptcone_k'                      ] = (ROOT.RDF.TH1DModel('ptcone_k'                      , '', 50,      4,    30), 'ptcone k [GeV] '                                               , 0)
histos['kpt'                       ] = (ROOT.RDF.TH1DModel('kpt'                       , '', 50,      4,    30), '#mu_{3} p_{T} (GeV)'                                           , 0)
...
#histos['Bmass'                     ] = (ROOT.RDF.TH1DModel('Bmass'                     , '', 50,      0,     6.2), '3#mu mass (GeV)'                                               , 0)

histos['Bmass'                     ] = (ROOT.RDF.TH1DModel('Bmass'                     , '', 40,      3.2,     6.3), '3#mu mass (GeV)'                                               , 0)
#histos['Bmass'                     ] = (ROOT.RDF.TH1DModel('Bmass'                     , '', 30,      3.5,    10), '3#mu mass (GeV)'                                               , 0)
...
histos['Bpt_reco'                  ] = (ROOT.RDF.TH1DModel('Bpt_reco'                  , '', 30,      20,    60), 'corrected 3#mu p_{T} (GeV)'                                    , 0)
#histos['Bpt_reco'                  ] = (ROOT.RDF.TH1DModel('Bpt_reco'                  , '', 50,      0,    200), 'corrected 3#mu p_{T} (GeV)'                                    , 0)
...
histos['correction_svprob'               ] = (ROOT.RDF.TH1DModel('correction_svprob'               , '', 60,      0,     2), 'vtx(#mu_{1}, #mu_{2}, #mu_{3}) probability'                    , 0)
histos['bvtx_svprob_corr'               ] = (ROOT.RDF.TH1DModel('bvtx_svprob_corr'               , '', 50,      0,     1), 'vtx(#mu_{1}, #mu_{2}, #mu_{3}) probability'                    , 0)
histos['bvtx_svprob_corr_01'               ] = (ROOT.RDF.TH1DModel('bvtx_svprob_corr_01'               , '', 50,      0,     1), 'vtx(#mu_{1}, #mu_{2}, #mu_{3}) probability'                    , 0)
...
histos['bvtx_log10_lxy_sig'        ] = (ROOT.RDF.TH1DModel('bvtx_log10_lxy_sig'        , '', 20,     -1,     1.75), 'log_{10} vtx(#mu_{1}, #mu_{2}, #mu_{3}) L_{xy}/#sigma_{L_{xy}}', 1)
...
histos['jpsivtx_lxy'               ] = (ROOT.RDF.TH1DModel('jpsivtx_lxy'               , '',50,      0,     0.25), 'vtx(#mu_{1}, #mu_{2}) L_{xy} (cm)'                                                   , 1)
...
histos['jpsivtx_log10_lxy_sig_corr'] = (ROOT.RDF.TH1DModel('jpsivtx_log10_lxy_sig_corr', '', 15,     -0.9,     1.2), 'corrected log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}/#sigma_{L_{xy}}'         , 1)
...
histos_lowq2['jpsivtx_lxy'               ] = (ROOT.RDF.TH1DModel('jpsivtx_lxy'               , '',100,      0,     2), 'vtx(#mu_{1}, #mu_{2}) L_{xy} (cm)'                                                   , 1)
histos_lowq2['jpsivtx_log10_lxy'         ] = (ROOT.RDF.TH1DModel('jpsivtx_log10_lxy'         , '', 51,     -4,     1), 'log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}'                         , 1)
histos_lowq2['jpsivtx_lxy_unc'           ] = (ROOT.RDF.TH1DModel('jpsivtx_lxy_unc'           , '', 60,      0,  0.02), 'vtx(#mu_{1}, #mu_{2}) #sigma_{L_{xy}} (cm)'                                          , 1)

histos['jpsivtx_log10_lxy_sig'     ] = (ROOT.RDF.TH1DModel('jpsivtx_log10_lxy_sig'     , '', 15,     -0.9,     1.2), 'log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}/#sigma_{L_{xy}}'         , 1)
histos_lowq2['jpsivtx_log10_lxy_sig'     ] = (ROOT.RDF.TH1DModel('jpsivtx_log10_lxy_sig'     , '', 15,     -0.9,     1.2), 'log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}/#sigma_{L_{xy}}'         , 1)
histos_lowq2['jpsivtx_log10_lxy_sig_corr'] = (ROOT.RDF.TH1DModel('jpsivtx_log10_lxy_sig_corr', '', 15,     -0.9,     1.5), 'corrected log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}/#sigma_{L_{xy}}'         , 1)
...
histos_lowq2['m_miss_sq'                 ] = (ROOT.RDF.TH1DModel('m_miss_sq'                 , '', 10,      0,    1.1), 'm^{2}_{miss} (GeV^{2})'                                        , 0)
...
histos['k_softID'                  ] = (ROOT.RDF.TH1DModel('k_softID'                  , '',  2,      0,     2), '#mu_{3} softID'   
                                             , 0)
...
histos['dr_jpsi_mu'                ] = (ROOT.RDF.TH1DModel('dr_jpsi_mu'                , '', 50,      0,   1), '#DeltaR(J/#Psi, #mu_{3})'                                      , 0)
...
histos['ip3d_sig_dcorr'             ] = (ROOT.RDF.TH1DModel('ip3d_sig_dcorr'             , '', 30,     -4.5,     4.5), 'corrected #mu_{3} IP3D(vtx_{J/#Psi}) significance'             , 0)
histos_lowq2['ip3d_sig_dcorr'             ] = (ROOT.RDF.TH1DModel('ip3d_sig_dcorr'             , '', 30,     -5,     5), 'corrected #mu_{3} IP3D(vtx_{J/#Psi}) significance'             , 0)
...
histos_lowq2['norm'                      ] = (ROOT.RDF.TH1DModel('norm'                      , '',  1,      0,     1), 'normalisation'                                                 , 0)
'''
...
for his in histos:
    if his in histos_lessbins:
        continue
    else:
        histos_lessbins[his] = histos[his]
