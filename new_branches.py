to_define = [
    ('jpsivtx_fit_mass_corr'     , '0.9990*jpsivtx_fit_mass*(run==1) + jpsivtx_fit_mass*(run>1)'            ),
    ...
    ('ip3d_e_corr_new'           , '1.12*ip3d_e*(run==1) + ip3d_e*(run>1)'                        ),
    ('ip3d_corr'                 , '1.16*ip3d*(run==1) + ip3d*(run>1)'                        ),
    ('ip3d_sig'                  , 'ip3d/ip3d_e'                                                  ),
    ('ip3d_sig_dcorr'             , 'ip3d_corr/ip3d_e_corr_new'                                             ),
