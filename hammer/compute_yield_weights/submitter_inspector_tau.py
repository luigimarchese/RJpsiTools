...
print(files)
nfiles = len(files)
out_dir = 'Rjpsi_inspector_bc_tau_12nov21_v1'
files_per_job = 1
njobs = int(nfiles/files_per_job)
print(njobs," will be submitted")

template_inspector = "inspector_tau_TEMPLATE.py"
template_fileout = "RJpsi_inspector_bc_tau_12nov21_v1_TEMPLATE.root"
...
for ijob in range(njobs):
    ...
    for line in fin:
        ...
        elif   'HOOK_INPUT'    in line: fout.write(line.replace('HOOK_INPUT'   , "/RJPsi_Bc_GEN_12nov21_v1/"))
