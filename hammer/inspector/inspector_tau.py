...
#from kiselev_paths_tau import files
#from ebert_paths import files
from ebert_paths_tau import files
...
#files = glob('/pnfs/psi.ch/cms/trivcat/store/user/manzoni/RJPsi_BcToJpsiTauNu_GEN_FF_Kiselev_16feb21_v1/*.root')
...
fout = ROOT.TFile('%s/flat_tree_tau_ebert_13Apr21.root' %(destination), 'recreate')
