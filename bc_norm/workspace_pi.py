...
data_files = ['/pnfs/psi.ch/cms/trivcat/store/user/friti/dataframes_2021Mar15/data_ptmax_merged.root']

data_tree = ROOT.TChain('BTo2MuP')
for fname in data_files:
   data_tree.AddFile(fname)


signal_files = ['/pnfs/psi.ch/cms/trivcat/store/user/friti/dataframes_2021Mar15/BcToJPsiMuMu_is_jpsi_pi_merged.root']

signal_tree = ROOT.TChain('BTo2MuP')
...
print("Fit to mc integral ",(1.+0.079)*(mc_nsig_narrow.getVal() + mc_nsig_broad.getVal()))
##########################################################################################
