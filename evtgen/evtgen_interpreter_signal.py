...
if __name__ == '__main__':
    ...
    particles['MyBc-'] = Particle(
        ...
        [
            ...
            Decay(0.081606, [particles["MyJ/psi"  ], particles["pi-"     ], particles["pi-"         ], particles["pi+" ], particles["pi-"], particles["pi+" ]], "PHOTOS BC_VNPI 1"                         , 'https://inspirehep.net/literature/1288067'                                                                                                                     ),
