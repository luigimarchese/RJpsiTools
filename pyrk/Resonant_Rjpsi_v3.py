    ...
    for i,fname in enumerate(paths):
        ...
        for channel in channels:
            ...
            for selection,name in zip(flag_selection, flag_names):
                ...
                #hammer
                if(dataset == args.mc_mu and flag_hammer):
                    ham = Hammer()
                    fbBuffer = IOBuffer
                    ...
                    for i in range(len(bcands_flag)): #loop on the events
                        ...
                        #themu1_p4   = ROOT.Math.LorentzVector('ROOT::Math::PtEtaPhiM4D<double>')(bcands_flag.mu1.gen.p4.pt[i] , bcands_flag.mu1.gen.p4.eta[i],bcands_flag.mu1.gen.p4.phi[i] , 0.1056583755)
                        #themu2_p4   = ROOT.Math.LorentzVector('ROOT::Math::PtEtaPhiM4D<double>')(bcands_flag.mu2.gen.p4.pt[i] , bcands_flag.mu2.gen.p4.eta[i],bcands_flag.mu2.gen.p4.phi[i] , 0.1056583755)
                        ...
                        #thejpsi_p4 = themu1_p4 + themu2_p4
                        thenu_p4   = thebc_p4 - themu_p4 - thejpsi_p4
                        #                        print(bcands_flag.k.mother.pdgId[i],bcands_flag.mu1.mother.pdgId[i],bcands_flag.mu2.grandmother.pdgId[i])
                        #print(thejpsi_p4.mass(),thenu_p4.mass())
