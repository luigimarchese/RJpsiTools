...
histos['mu1pt'                     ] = ['mu1pt'                     , '', 50,      4,    30, '#mu_{1} p_{T} (GeV)']                                           
histos['mu2pt'                     ] = ['mu2pt'                     , '', 50,      4,    15, '#mu_{2} p_{T} (GeV)']                                           
histos['kpt'                       ] = ['kpt'                       , '', 50,      4,    15, '#mu_{3} p_{T} (GeV)']                                           
...
histos['mu1eta'                    ] = ['mu1eta'                    , '', 30,     -2.5,     2.5, '#mu_{1} #eta'       ]                                               
histos['mu2eta'                    ] = ['mu2eta'                    , '', 30,     -2.5,     2.5, '#mu_{1} #eta'       ]                                              
histos['keta'                      ] = ['keta'                      , '', 30,     -2.5,     2.5, '#mu_{1} #eta'       ]                                              
histos['Bpt'                       ] = ['Bpt'                       , '', 50,      10,    50, '3#mu p_{T} (GeV)'   ]                                              
histos['Bmass'                     ] = ['Bmass'                     , '', 60,      3,    10, '3#mu mass (GeV)'    ]                                               
histos['m12'                     ] = ['m12'                     , '', 50,      3,    3.2, 'm12 (GeV)'    ]                                               
histos['m13'                     ] = ['m13'                     , '', 100,      2.5,    3.5, 'm13 (GeV)'    ]                                               
histos['m23'                     ] = ['m23'                     , '', 100,      2.5,    3.5, 'm23 (GeV)'    ]                                               
histos['Beta'                      ] = ['Beta'                      , '', 30,     -2.5,     2.5, '3#mu eta' ]                                                     
histos['abs_Beta'                      ] = ['abs_Beta'                      , '', 20,     0,     2.5, '|3#mu eta|' ]                                                     
histos['Bphi'                      ] = ['Bphi'                      , '', 20, -np.pi, np.pi, '3#mu #phi']                                                     
histos['Bpt_reco'                  ] = ['Bpt_reco'                  , '', 50,      10,    80, 'corrected 3#mu p_{T} (GeV)']                                    
histos['abs_mu1_dxy'               ] = ['mu1_dxy'                   , '', 50,      0,   0.04, '#mu_{1} |d_{xy}| (cm)']                                         
#histos['mu1_dxy_sig'               ] = ['mu1_dxy_sig'               , '', 50,      0,    10, '#mu_{1} |d_{xy}|/#sigma_{d_{xy}}']
histos['abs_mu2_dxy'               ] = ['mu2_dxy'                   , '', 50,      0,   0.04, '#mu_{2} |d_{xy}| (cm)']                                         
histos['mu2_dxy_sig'               ] = ['mu2_dxy_sig'               , '', 50,      0,    10, '#mu_{2} |d_{xy}|/#sigma_{d_{xy}}' ]                             
histos['abs_k_dxy'                 ] = ['k_dxy'                     , '', 50,      0,   0.04, '#mu_{3} |d_{xy}| (cm)']                                         
histos['k_dxy_sig'                 ] = ['k_dxy_sig'                 , '', 50,      0,    10, '#mu_{3} |d_{xy}|/#sigma_{d_{xy}}'  ]                            
histos['abs_mu1_dz'                ] = ['mu1_dz'                    , '', 50,      0,   0.05, '#mu_{1} |d_{z}| (cm)']                                          
histos['mu1_dz_sig'                ] = ['mu1_dz_sig'                , '', 50,      0,    10, '#mu_{1} |d_{z}|/#sigma_{d_{z}}'     ]                           
histos['abs_mu2_dz'                ] = ['mu2_dz'                    , '', 50,      0,   0.1, '#mu_{2} |d_{z}| (cm)']                                          
histos['mu2_dz_sig'                ] = ['mu2_dz_sig'                , '', 50,      0,    10, '#mu_{2} |d_{z}|/#sigma_{d_{z}}'     ]                           
histos['abs_k_dz'                  ] = ['k_dz'                      , '', 50,      0,   0.1, '#mu_{3} |d_{z}| (cm)']                                          
...
histos['bvtx_chi2'                 ] = ['bvtx_chi2'                 , '', 50,      0,    20, 'vtx(#mu_{1}, #mu_{2}, #mu_{3}) #chi^{2}']                       
histos['bvtx_lxy'                  ] = ['bvtx_lxy'                  , '',100,      0,     0.3, 'L_{xy} (cm)']                                                   
histos['bvtx_lxy_sig'              ] = ['bvtx_lxy_sig'              , '', 50,      0,    30, 'L_{xy}/#sigma_{L_{xy}}'                  ]                      
histos['bvtx_lxy_unc'              ] = ['bvtx_lxy_unc'              , '', 60,      0,  0.02, '#sigma_{L_{xy}} (cm)']                                          
histos['bvtx_lxy_sig_corr'         ] = ['bvtx_lxy_sig_corr'         , '', 50,      0,    30, 'corrected L_{xy}/#sigma_{L_{xy}}'         ]                     
...
histos['bvtx_log10_svprob'         ] = ['bvtx_log10_svprob'         , '', 51,     -4,     0.1, 'log_{10} vtx(#mu_{1}, #mu_{2}, #mu_{3}) probability'           ]
histos['bvtx_log10_lxy'            ] = ['bvtx_log10_lxy'            , '', 51,     -4,     0, 'log_{10} vtx(#mu_{1}, #mu_{2}, #mu_{3}) L_{xy}'                ]
histos['bvtx_log10_lxy_sig'        ] = ['bvtx_log10_lxy_sig'        , '', 51,     -2,     2, 'log_{10} vtx(#mu_{1}, #mu_{2}, #mu_{3}) L_{xy}/#sigma_{L_{xy}}']
histos['bvtx_cos2D'                ] = ['bvtx_cos2D'                , '',60,    0.98,     1, '2D cos#alpha'                                                  ]
histos['jpsivtx_chi2'              ] = ['jpsivtx_chi2'              , '', 40,      0,    5, 'vtx(#mu_{1}, #mu_{2}) #chi^{2}'                                ]
histos['jpsivtx_lxy_sig'           ] = ['jpsivtx_lxy_sig'           , '', 50,      0,    30, 'L_{xy}/#sigma_{L_{xy}}'                                        ]
histos['jpsivtx_lxy_sig_corr'           ] = ['jpsivtx_lxy_sig'           , '', 50,      0,    60, 'L_{xy}/#sigma_{L_{xy}}'                                        ]
histos['jpsivtx_lxy'               ] = ['jpsivtx_lxy'               , '',100,      0,     0.3, 'L_{xy} (cm)']                                                   
...
histos['jpsivtx_log10_svprob'      ] = ['jpsivtx_log10_svprob'      , '', 51,     -2,     0.1, 'log_{10} vtx(#mu_{1}, #mu_{2}) probability'                    ]
histos['jpsivtx_log10_lxy'         ] = ['jpsivtx_log10_lxy'         , '', 51,     -4,     0, 'log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}'                         ]
histos['jpsivtx_log10_lxy_sig'     ] = ['jpsivtx_log10_lxy_sig'     , '', 51,     -2,     2, 'log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}/#sigma_{L_{xy}}'         ]
histos['jpsivtx_log10_lxy_sig_corr'     ] = ['jpsivtx_log10_lxy_sig_corr'     , '', 51,     -2,     2, 'log_{10} vtx(#mu_{1}, #mu_{2}) L_{xy}/#sigma_{L_{xy}}'         ]
histos['jpsivtx_cos2D'             ] = ['jpsivtx_cos2D'             , '',60,    0.98,     1, '2D cos#alpha'                                                  ]
...
histos['pt_var'                    ] = ['pt_var'                    , '', 50,      0,    35, 'p_{T}^{var} (GeV)']                                             
histos['pt_miss_vec'               ] = ['pt_miss_vec'               , '', 50,      0,    35, 'vector p_{T}^{miss} (GeV)']                                     
histos['pt_miss_scal'              ] = ['pt_miss_scal'              , '', 60,    -10,    35, 'scalar p_{T}^{miss} (GeV)']                                     
...
histos['DR_mu1mu2'                 ] = ['DR_mu1mu2'                 , '', 50,      0.1,   0.8, '#DeltaR(#mu_{1}, #mu_{2})']                                     
histos['DR_jpsimu'                 ] = ['DR_jpsimu'                 , '', 50,      0,   1.2, '#DeltaR(J/#psi, #mu)']                                     
# histos['jpsi_chi2'                 ] = ['jpsi_chi2'                 , '', 80,      0,  20. , 'vtx(#mu_{1}, #mu_{2}) #chi^{2}'                                ]
# histos['Bchi2'                     ] = ['b_chi2'                    , '', 80,      0,  35. , 'vtx(#mu_{1}, #mu_{2}, #mu_{3}) #chi^{2}'                       ]
histos['jpsi_mass'                 ] = ['jpsi_mass'                 , '', 50,    3,   3.2, 'm(#mu_{1}, #mu_{2}) (GeV)']                                     
histos['jpsi_pt'                   ] = ['jpsi_pt'                   , '', 50,      10,    50, '(#mu_{1}, #mu_{2}) p_{T} (GeV)']                                
histos['jpsi_eta'                  ] = ['jpsi_eta'                  , '', 30,     -2.5,     2.5, '(#mu_{1}, #mu_{2}) #eta'                                       ]
histos['jpsi_phi'                  ] = ['jpsi_phi'                  , '', 20, -np.pi, np.pi, '(#mu_{1}, #mu_{2}) #phi'                                       ]
histos['dr12'                      ] = ['dr12'                      , '', 50,      0.1,   0.8, '#DeltaR(#mu_{1}, #mu_{2})']                                     
...
'''
histos['jpsiK_mass'                ] = ['jpsiK_mass'                , '', 80,      3.5,     7, '(J/#Psi + K^{+}) mass (GeV)']                                   
...
histos['ip3d'                      ] = ['ip3d'                      , '', 50,  -0.03,  0.02, '#mu_{3} IP3D(vtx_{J/#Psi}) (cm)'                               ]
histos['ip3d_corr'                      ] = ['ip3d_corr'                      , '', 50,  -0.05,  0.05, '#mu_{3} IP3D(vtx_{J/#Psi}) (cm)'                               ]
histos['ip3d_e'                    ] = ['ip3d_e'                    , '', 50,      0.002,  0.01, '#mu_{3} IP3D(vtx_{J/#Psi}) unc. (cm)'                          ]
histos['ip3d_e_corr_new'                    ] = ['ip3d_e_corr_new'                    , '', 50,      0.002,  0.01, '#mu_{3} IP3D(vtx_{J/#Psi}) unc. (cm)'                          ]


histos['ip3d_sig'             ] = ['ip3d_sig'             , '', 50,     -5,     5, '#mu_{3} IP3D(vtx_{J/#Psi}) significance'             ]
histos['ip3d_sig_dcorr'             ] = ['ip3d_sig_dcorr'             , '', 50,     -5,     5, 'corrected #mu_{3} IP3D(vtx_{J/#Psi}) significance'             ]
...
histos['decay_time_pv_jpsi'                ] = ['decay_time'                , '', 50,      0,  2e-12, 't (ps)']                                                         
