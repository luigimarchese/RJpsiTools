...
histos['Blxy_unc'     ] = (ROOT.RDF.TH1DModel('Blxy_unc'      , '',150,      0,  0.04), '#sigma_{L_{xy}} (cm)'                               , 1)
...
# histos['decay_time1'  ] = (ROOT.RDF.TH1DModel('decay_time1'   , '', 50,      0,  4e-9), 't (s)'                                              , 0)
# histos['decay_time2'  ] = (ROOT.RDF.TH1DModel('decay_time2'   , '', 50,      0,  4e-9), 't (s)'                                              , 0)
