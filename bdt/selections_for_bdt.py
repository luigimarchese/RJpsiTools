...
#extra = ' & '.join(['k_mediumID>0.5'])

preselection_mc = ' & '.join([prepreselection, triggerselection, etaselection, 'k_mediumID>0.5 & abs(k_genpdgId)==13'])
preselection_fakes_1 = ' & '.join([prepreselection, triggerselection, etaselection, 'k_mediumID<0.5 & k_raw_db_corr_iso03_rel<0.2'])#, 'k_mediumID<0.5'])
preselection_fakes_2 = ' & '.join([prepreselection, triggerselection, etaselection, 'k_mediumID<0.5 & k_raw_db_corr_iso03_rel>0.2'])#, 'k_mediumID<0.5'])
